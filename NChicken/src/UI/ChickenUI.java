...
public class ChickenUI extends JFrame implements ActionListener{
	...
	private JTextField textField;//닭품종
	private JTextField textField_1;//닭등급
	private JTextField textField_2;//닭나이
	private JButton btnNewButton;//닭등록
	private ChickenDAO dao; //dao 전역변수 지정해놓기
	private JList list;
	...
	private JButton btnNewButton_2;//닭삭제
	...
	public void makeTable() {
		...
		String columnNames[]= {"알고유번호","알가격","알등급"};
